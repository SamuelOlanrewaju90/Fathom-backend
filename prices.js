...
// Cached briefly in memory so we don't hammer CoinGecko or hit its
// rate limit every time a browser tab refreshes.
...
const CACHE_MS = 20_000; // 20 seconds
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    // If CoinGecko is unreachable, serve the last good cache rather than failing outright.
